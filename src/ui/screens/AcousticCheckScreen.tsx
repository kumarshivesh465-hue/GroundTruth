  ...
  return (
    <div className="flex-1 flex flex-col bg-white select-none">
      ...
      <div className="flex-1 px-5 py-3 space-y-3.5 overflow-y-auto flex flex-col">
        ...
        <div className="space-y-1"><h2 className="text-[20px] font-bold text-slate-900 tracking-tight" style={{ fontFamily: 'var(--font-heading)' }}>Acoustic Sweep</h2><p className="text-[13px] text-slate-600 leading-snug">Place the phone near the cylinder as it was during calibration. The app plays a short sweep and compares its frequency profile locally.</p></div>

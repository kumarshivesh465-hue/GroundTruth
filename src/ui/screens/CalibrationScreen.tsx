      ...
      <div className="flex-1 px-5 py-4 space-y-4 overflow-y-auto">
        ...
        <div className="rounded-2xl border border-slate-200 p-4 space-y-3">
          <div>
            ...
            <p className="mt-1 text-xs text-slate-600 leading-relaxed">Use the same phone position near the same container for all three recordings. This records a 32-value frequency profile, not an audio file.</p>
          </div>
